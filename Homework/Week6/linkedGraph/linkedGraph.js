...
d3.csv("linkedGraphData.csv", function(error, data) {
    ...
    // rewrite data for spider to format: [{name: "wellbeing", value: "1"}, {name: "footprint", value: "1"}, {name: "ren", value: "1"}] 
    var dataforspider = [];
  ...
  var tip = d3.tip()
    ...
    svg.selectAll(".dot")
      ...
      .enter().append("circle")
        ...
        .on('click', function(d){ updateSpider(dataforspider[d.country])})
...
//this function still has to be written correctly 
    ...
    var circles = svg.selectAll(".inner")
        .data(x.ticks(5))
        .attr("r", function(d) {return barScale(d);})
        .enter()
            .append("circle")
