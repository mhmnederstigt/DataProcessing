...
d3.csv("linkedGraphData3.csv", function(error, data) {
  ...
  var margin = {top: 20, right: 20, bottom: 30, left: 20},
      scatterWidth = 700 - margin.left - margin.right,
  ...
  var tip = d3.tip()
    ...
    svg.selectAll(".dot")
      ...
      .enter().append("circle")
        ...
        .on('click', function(d){ updateradialbar(dataforradialbar[d.country]); titleDisplay(d.country)})
